  ...
  <main>
    <center>
      <div class="content-body">
        <h1>Acerca de</h1>
        <h4 class="titulo-datos">Datos de la empresa</h4>
        <h4 class="titulo-datos">Datos de la divisón</h4>
        <h4 class="titulo-datos">Misión</h4>
        <h4 class="titulo-datos">Visión</h4>
        <h4 class="titulo-datos">entre otros</h4>
      </div>
    </center>
  </main>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="widget no-box">
              ...
              <ul class="thumbnail-widget">
                ...
                <li>
                  <div class="thumb-content"><a href="ayuda.php">Ayuda</a></div>
                </li>
                <li>
                  <div class="thumb-content"><a href="acerca_de.php">Acerca de</a></div>
                </li>
              </ul>
            </div>
          </div>
